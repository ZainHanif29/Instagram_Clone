              ...
              <div className="flex flex-col gap-5">
                <div className="flex items-center gap-2">
                  ...
                  {isLoggedInProfile ? (
                    ...
                    <Button className="bg-[#0095F6] hover:bg-[#377096] h-8">
                      Follow
                    </Button>
                  )}
                </div>
              ...
              displayedPost?.map((post)=>{
                return(
                 ...
                 <div key={post?._id} className="relative group cursor-pointer">
                  <img src={post.image} alt="img" className="rounded-sm my-2 w-full aspect-square object-contain" />
